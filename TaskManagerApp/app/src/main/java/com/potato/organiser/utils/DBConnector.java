package com.potato.organiser.utils;
...
import com.potato.organiser.Observer.ObiectSubject;
...
public class DBConnector extends SQLiteOpenHelper implements ObiectSubject {
    ...
    //TODO
//    public boolean exportTheDB() throws IOException {
...
//            myOutWriter.append("Titlu , Ora , Ziua , Tipul , Prioritate , Descriere");
//            myOutWriter.append("\n");
//
//            open();
//            Cursor c = tasksDB.rawQuery("SELECT * FROM  Task WHERE Type = 1  ", null);
//            succes = true;
//            if (c != null) {
//                if (c.moveToFirst()) {
//                    do {
...
//                        myOutWriter.append(task.getTitle() + " , " + task.getHour() + " , " + task.getDate() + " , " + task.getType() + " , " + task.getPriority() + " , " + task.getDescription());
//                        myOutWriter.append("\n");
//                    }
//
//                    while (c.moveToNext());
...
//    }
    ...
    public ArrayList<Priority> findAllPriorities() {
        ...
        try {
            cursor = tasksDB
                    .rawQuery("SELECT * FROM Priority", null);
            cursor.moveToFirst();
            do {
                String id = cursor.getString(0);
                String JSON = cursor.getString(1);
    ...
    public ArrayList<Event> findEventsBetween(String startDate, String endDate){
        ArrayList<Event> events = new ArrayList<Event>();
        try {
            open();
        } catch (Exception e) {
